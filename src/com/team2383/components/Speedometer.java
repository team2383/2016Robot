...
/**
 * A speedometer is a device that measures the instantaneous linear speed of a device in inches per second. 
 * Convenience constructors are provided to convert one or more {@link Gyroscope} to a {@link Speedometer}.
 *
...
public interface Speedometer extends SpeedSensor {
	...
	/**
	 * Gets the current speed of this {@link Speedometer}.
	 * Default unit is ft/s
	 * 
	 * @return the value of this {@link Speedometer}
	 * @see #getSpeedInFeetPerSecond()
	 */
    ...
    /**
     * Create a speedometer for the given functions that return angular velocity, and a function to convert
     * angular velocity into linear speed in in/s.
     *
     * @param scale constant scaling factor that turns the angular velocity to linear speed in inches per second.
     * @param angularVelocity the function(s) that returns the angular velocity; may not be null
    ...
    public static Speedometer create(DoubleToDoubleFunction scaleFunction, DoubleSupplier... angularVelocitySuppliers) {
        return new Speedometer() {
            ...
            public double getSpeedInInchesPerSecond() {
            	...
            	for (DoubleSupplier angularVelocitySupplier : angularVelocitySuppliers) {
