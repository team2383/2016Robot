...
public class SpyBoxCharlieAuto extends CommandGroup{
	/*
	 * calls autonomous commands sequentially and simultaneously
	 * 
	 * This auto starts in the spy box, moves to shoot, and goes back and forth through the "Charlie" Obstacle
	 * 
	 * Points: 20
	 */
	...
	final AHRS ahrs;
	public SpyBoxCharlieAuto(Robot robot) {
         ...
         * 5) drive forward parallel to midway of the Charlie obstacle
         * 6) turn toward Charlie obstacle
