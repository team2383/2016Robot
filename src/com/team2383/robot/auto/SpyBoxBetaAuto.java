...
public class SpyBoxBetaAuto extends CommandGroup{
	/*
	 * calls autonomous commands sequentially and simultaneously
	 * 
	 * This auto starts in the spy box, moves to shoot, and goes back and forth through the "Beta" Obstacle
	 * 
	 * Points: 20
	 */
	...
	final AHRS ahrs;
	public SpyBoxBetaAuto(Robot robot) {
         ...
         * 5) drive forward parallel to midway of the Beta obstacle
         * 6) turn toward Beta obstacle
        ...
        sequentially(new Drive(controller, () -> controller.withTarget(-90) , Robot.drive, 60),
        			 ...
        			 new Drive(controller, () -> controller.withTarget(90) , Robot.drive, 48),
