...
public class SpyBoxEchoAuto extends CommandGroup{
	/*
	 * calls autonomous commands sequentially and simultaneously
	 * 
	 * This auto starts in the spy box, moves to shoot, and goes back and forth through the "Echo" Obstacle
	 * 
	 * Points: 20
	 */
	...
	final AHRS ahrs;
	public SpyBoxEchoAuto(Robot robot) {
         ...
         * 5) drive forward parallel to midway of the Echo obstacle
         * 6) turn toward Echo obstacle
		...
		sequentially(new Hood(1.0,1.0),				
        			 new Shoot(1),
        			 new Drive(controller, () -> controller.withTarget(0), (x)->ahrs.getVelocityZ(), (x)->ahrs.getVelocityZ() , Robot.drive,12));
        ...
        sequentially(new Drive(controller, () -> controller.withTarget(-90) , Robot.drive, 60),
        			 ...
        			 new Drive(controller, () -> controller.withTarget(90) , Robot.drive, 192),
