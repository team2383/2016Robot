...
public class Config {
    ...
    static int LEFT_FRONT_MOTOR_PORT = 3;
    static int LEFT_REAR_MOTOR_PORT = 4;
    static int RIGHT_FRONT_MOTOR_PORT = 5;
    static int RIGHT_REAR_MOTOR_PORT = 6;
    ...
    // for climber
    public static int RIGHT_EXTEND_CLIMBER_PORT = 4;
    ...
    public static int FEEDER_MOTOR_PORT = 8;
